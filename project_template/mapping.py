...
food_buckets = {
	...
	'fish' : set(['tuna','cod','trout','bass','salmon', 'anchovy','bream','catfish','cod','eel','flounder','grouper','haddock','halibut','herring','mackerel', 'mahi mahi','monkfish','mullet','pike','pollock','sardine','skate','smelt','snapper','sole','tilapia','tuna','whitefish']),
	...
	'spicy' : set(['cayenne','tabasco','jalapeno','habanero','hot sauce','sichuan','siracha','tabasco','scotch bonnet','thai pepper','thai chile','serrano','hungarian wax pepper','hatch','poblano','ancho chile','shishito','italian long hots','pimento','banana pepper','gochujang','harissa','sambal','nam phrik','chili oil','shito','zhug','salsa','cholula','pico de gallo','salsa verde']),
